...
function Mission() {
  return (
    <div className='py-10 min-h-96' style={{ backgroundColor: "var(--background-color)" }}>
      <div className='mt-10 grid grid-cols-2 gap-20 w-[70%] mx-auto text-center'>
        <div>
          ...
          <h2 className='text-2xl leading-10 mt-5 w-96 mx-auto mb-12' style={{ color: "var(--text-color)" }}>ماموریت ما نوآوری و انگیزه برای دستیابی به برتری و پذیرش چالش های تغییر در صنعت مو است. تا آرایشگران ما بتوانند به صنعت مو به نفع مشتریان کمک کنند.</h2>
